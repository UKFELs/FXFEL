...
py=data2[:,4]
pz=data2[:,5]
# Scale time to seconds - Astra uses nanoseconds
time=data2[:,6]*1.E-9
macrocharge=data2[:,7]
...
# Shift the z axis to be compliant with SDDS astra2elegant.
P=np.sqrt(norm_px**2+norm_py**2+norm_pz**2)
Beta_z=norm_pz/P
SwitchParam=norm_time[0]*c*Beta_z[0]-norm_z[0]
print 'Switch parameter = ',SwitchParam
norm_z=norm_z+SwitchParam

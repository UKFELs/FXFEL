...
# Shows the arguments passed to script when run - this is the name of your input file.
print ("File arguments: %s " % file_name_in)
...
file_output=open('H5LS_OUT.TXT','w')
...
output_file=tables.open_file('OUT_'+file_name_in,'w')

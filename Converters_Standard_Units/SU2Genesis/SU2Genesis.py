...
if len(sys.argv)==2:
   ...
   print 'Usage: SU2Genesis <FileName> \n'
   sys.exit(1)  
...
# No need to divide momentum over mc as this script is meant for scaled units !!!!
n=len(Electrons)
...
Py = Electrons[:,3]
Z = Electrons[:,4]
P = (np.sqrt(Electrons[:,1]**2+Electrons[:,3]**2+Electrons[:,5]**2))

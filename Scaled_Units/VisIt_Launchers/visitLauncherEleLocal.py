...
LocalVisItPyDir=LocalVisItDir+os.path.sep+"2.10.2/linux-x86_64/lib/site-packages"

sys.path.insert(0,LocalVisItPyDir)
import visit
...
data=visit.OpenDatabase('/home/ptracz/test_sdds/test_analyzeBeam.h5',0,'Vs')

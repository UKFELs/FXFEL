...
if len(sys.argv)==3:
   ...
   print 'Usage: FBIC2SI_5 <FileName> <PaticleSpecies>\n'
...
m_PX=np.array(f[root_dir+'/'+time_step+'/particles/'+species+'/momentum/x'])
m_PY=np.array(f[root_dir+'/'+time_step+'/particles/'+species+'/momentum/y'])
m_PZ=np.array(f[root_dir+'/'+time_step+'/particles/'+species+'/momentum/z'])

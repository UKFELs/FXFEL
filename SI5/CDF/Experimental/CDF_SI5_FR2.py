...
from scipy.interpolate import InterpolatedUnivariateSpline,spline
...
#f_Z = interp1d(x0_Z, y0_Z,kind='cubic')
...
plt.ylabel('CDF')
plt.grid(True)
plt.plot(xx_0_Z, cumulative_nq_Z, label='CDF')
plt.show()

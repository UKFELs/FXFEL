...
# LocalSettings
LocalVisItDir = "/home/ptracz/VisIt"
localPythonPackageDir = LocalVisItDir+os.path.sep+"2.10.2/linux-x86_64/lib/site-packages"
global runRemotely
runRemotely=0
...
#remoteElePhaseSpaceDB='/home/ptracz/test_sdds/phase100_hartree/clara_track_electrons_*.vsh5 database'
...
localTimeSeriesAstraDB='/home/ptracz/test_sdds/phase100_hartree/test_analyzeBeam.h5'
localTimeSeriesEleSigmaDB='/home/ptracz/test_sdds/phase100_hartree/clara.sig-page1.h5'
localElePhaseSpaceDB='/home/ptracz/test_sdds/phase100_hartree/clara_track_electrons_*.vsh5 database'
#Remote settings
...
#    psData=visit.OpenDatabase(remoteElePhaseSpaceDB,elementNo,'Vs')
    if runRemotely:
      ...
      psData=visit.OpenDatabase(localElePhaseSpaceDB,0,'Vs')
...
#  data2=visit.OpenDatabase(remoteTimeSeriesAstraDB,0,'Vs')
  ...
  data=visit.OpenDatabase(localTimeSeriesEleSigmaDB,0,'Vs')
TimeSeriesS1()
PhaseSpaceXY(2)
